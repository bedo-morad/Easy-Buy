package com.easybuy.easybuy.email;

import com.easybuy.easybuy.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("contact@easybuy.com");
        ...
        try {
            ...
            log.warn("Couldn't send email to {}", destinationEmail);
        }
    }
